...
| 32 |**sudo john --wordlist=/usr/share/john/password.lst /etc/shadow**|Realiza la prueba de decifrar la contraseña y nos indica el tiempo que demora en desifrarla|<div align=center><img src="img/img09.png"></div>
| 33 |**sudo passwd test**|Hacemos un test del nuevo password|<div align=center><img src="img/img10.png"></div>
| 34 |**sudo john /etc/shadow**|Realiza la prueba de decifrar la contraseña|<div align=center><img src="img/img11.png"></div>
